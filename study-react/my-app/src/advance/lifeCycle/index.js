// 参考文章：https://juejin.im/post/5df648836fb9a016526eba01#heading-13
// 旧版React生命周期
...
export default class LifeCycle extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    console.log('componentWillReceiveProps 组件将接收新的props')
  }
...
class SubCounter extends Component{
    ...
    //componentWillReceiveProps 组件收到新的属性对象
    componentWillReceiveProps(nextProps){
    ...
    render(){
        console.log('SubCounter  2.render: ',this.props)
        return(
